...
class MultiDataset:
    ...
    def verbose(self):
        for i in range(len(self.datasets)):
            ...
            print('Dataset:%8s size:%6d nclass:%6d  %.3f' % (dataset.name(), 
              dataset.size(), dataset.numOfClass(), self.weights[i]))
        print('------------------------------------------------------------')
        print('Dataset:%8s size:%6d nclass:%6d' % ('total', self.size(), self.numOfClass()))
